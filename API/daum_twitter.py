...
class DaumTwitter(object):
    seed_url = u"http://m.search.daum.net/qsearch?w=swBoard&qsearch_ver=v2&viewtype=json&search_option=mobile&sort_type=&n={{limit}}&p=1&enddate=&begindate=&q={{kwd}}&retweet=&uk=VCE4ytPUJWwAABIVgg4AAADE"
